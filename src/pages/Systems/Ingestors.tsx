...
const IngestorsTable = () => {
	const fetchFileContent = () => {
		// Read the file content using the imported text file
		fetch(text)
		  .then(response => response.text())
		  .then(content => console.log(parsePrometheusResponse(content)))
		...
		return (
			<Table.Tr key={element.name}>
				...
				<Table.Td>
					<Tooltip label="">
						<UsageIndicator
							label={`${bytesToGiB(element.consumedMemory, false)} / ${bytesToGiB(element.totalMemory)}`}
