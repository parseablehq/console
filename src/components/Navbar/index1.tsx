import { NavLink, Select, Modal, Button, TextInput, Group } from '@mantine/core';
import {
	IconZoomCode,
	IconReportAnalytics,
	IconFileAlert,
...
type NavbarProps = Omit<any, 'children'>;
...
const Navbar: FC<NavbarProps> = (props) => {
	...
	return (
		...
		<nav {...props}>
			<Group grow className={container}>
				<NavLink
					label="Log Streams"
			...
			<Group className={lowerContainer}>
				<NavLink
					label={username}
